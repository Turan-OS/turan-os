...
const TOUR_STEPS: TourStep[] = [
  ...
  { selector: '[data-tour="column"]', title: 'Этапы воронки', text: 'Каждая колонка — стадия сделки: от первичного контакта до клиента. Перетаскивай карточку в следующую колонку, когда сделка двигается дальше.' },
